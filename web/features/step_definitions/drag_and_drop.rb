Dado("que acesso a página de Arrastar e Soltar") do
...
Então("devo verificar que o elemento A foi movido com sucesso para o local do elemento B") do
...
Então("devo verificar que o elemento B foi movido com sucesso para o local do elemento A") do
